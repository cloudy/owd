// Generated by gencpp from file owd_msgs/OpenDoorResponse.msg
// DO NOT EDIT!


#ifndef OWD_MSGS_MESSAGE_OPENDOORRESPONSE_H
#define OWD_MSGS_MESSAGE_OPENDOORRESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::owd_msgs::OpenDoorResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::owd_msgs::OpenDoorResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::owd_msgs::OpenDoorResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::owd_msgs::OpenDoorResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::owd_msgs::OpenDoorResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::owd_msgs::OpenDoorResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::owd_msgs::OpenDoorResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::owd_msgs::OpenDoorResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::owd_msgs::OpenDoorResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::owd_msgs::OpenDoorResponse_<ContainerAllocator>& v)
  {
    s << indent << "ok: ";
...
#endif // OWD_MSGS_MESSAGE_OPENDOORRESPONSE_H
