// Generated by gencpp from file owd_msgs/SetFingerCompliantResponse.msg
// DO NOT EDIT!


#ifndef OWD_MSGS_MESSAGE_SETFINGERCOMPLIANTRESPONSE_H
#define OWD_MSGS_MESSAGE_SETFINGERCOMPLIANTRESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::owd_msgs::SetFingerCompliantResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::owd_msgs::SetFingerCompliantResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::owd_msgs::SetFingerCompliantResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::owd_msgs::SetFingerCompliantResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::owd_msgs::SetFingerCompliantResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::owd_msgs::SetFingerCompliantResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::owd_msgs::SetFingerCompliantResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::owd_msgs::SetFingerCompliantResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::owd_msgs::SetFingerCompliantResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::owd_msgs::SetFingerCompliantResponse_<ContainerAllocator>& v)
  {
    s << indent << "ok: ";
...
#endif // OWD_MSGS_MESSAGE_SETFINGERCOMPLIANTRESPONSE_H
