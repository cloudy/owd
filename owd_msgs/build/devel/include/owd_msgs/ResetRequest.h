// Generated by gencpp from file owd_msgs/ResetRequest.msg
// DO NOT EDIT!


#ifndef OWD_MSGS_MESSAGE_RESETREQUEST_H
#define OWD_MSGS_MESSAGE_RESETREQUEST_H
...
std::ostream& operator<<(std::ostream& s, const ::owd_msgs::ResetRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::owd_msgs::ResetRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::owd_msgs::ResetRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::owd_msgs::ResetRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::owd_msgs::ResetRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::owd_msgs::ResetRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::owd_msgs::ResetRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::owd_msgs::ResetRequest_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::owd_msgs::ResetRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::owd_msgs::ResetRequest_<ContainerAllocator>&)
  {}
};
...
#endif // OWD_MSGS_MESSAGE_RESETREQUEST_H
