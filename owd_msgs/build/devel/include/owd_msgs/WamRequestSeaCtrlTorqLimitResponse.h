// Generated by gencpp from file owd_msgs/WamRequestSeaCtrlTorqLimitResponse.msg
// DO NOT EDIT!


#ifndef OWD_MSGS_MESSAGE_WAMREQUESTSEACTRLTORQLIMITRESPONSE_H
#define OWD_MSGS_MESSAGE_WAMREQUESTSEACTRLTORQLIMITRESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::owd_msgs::WamRequestSeaCtrlTorqLimitResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::owd_msgs::WamRequestSeaCtrlTorqLimitResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::owd_msgs::WamRequestSeaCtrlTorqLimitResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::owd_msgs::WamRequestSeaCtrlTorqLimitResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::owd_msgs::WamRequestSeaCtrlTorqLimitResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::owd_msgs::WamRequestSeaCtrlTorqLimitResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::owd_msgs::WamRequestSeaCtrlTorqLimitResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::owd_msgs::WamRequestSeaCtrlTorqLimitResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::owd_msgs::WamRequestSeaCtrlTorqLimitResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::owd_msgs::WamRequestSeaCtrlTorqLimitResponse_<ContainerAllocator>&)
  {}
};
...
#endif // OWD_MSGS_MESSAGE_WAMREQUESTSEACTRLTORQLIMITRESPONSE_H
