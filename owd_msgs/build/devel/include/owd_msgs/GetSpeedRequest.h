// Generated by gencpp from file owd_msgs/GetSpeedRequest.msg
// DO NOT EDIT!


#ifndef OWD_MSGS_MESSAGE_GETSPEEDREQUEST_H
#define OWD_MSGS_MESSAGE_GETSPEEDREQUEST_H
...
std::ostream& operator<<(std::ostream& s, const ::owd_msgs::GetSpeedRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::owd_msgs::GetSpeedRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::owd_msgs::GetSpeedRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::owd_msgs::GetSpeedRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::owd_msgs::GetSpeedRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::owd_msgs::GetSpeedRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::owd_msgs::GetSpeedRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::owd_msgs::GetSpeedRequest_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::owd_msgs::GetSpeedRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::owd_msgs::GetSpeedRequest_<ContainerAllocator>&)
  {}
};
...
#endif // OWD_MSGS_MESSAGE_GETSPEEDREQUEST_H
